...
// dsh-code-colors. It is idempotent and needs no network.
//
// Run it after a `pnpm install` in the profile: pnpm prunes node_modules entries
// it does not find in package.json, and this package is deliberately NOT added
// there (see README.md — "Registering it").
//
